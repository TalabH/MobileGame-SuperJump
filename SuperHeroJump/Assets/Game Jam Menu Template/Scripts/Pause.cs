...
public class Pause : MonoBehaviour {
	...
	public void DoPause()
	{
		...
		//GameObject control = GameObject.Find ("playercontrol");
		//control.SetActive (false)
		if (Application.loadedLevelName == "Main") {
			GameObject.Find ("control").GetComponent<control> ().HideCanvas ();
		}
		if (Application.loadedLevelName == "GameOver") {
			GameObject.Find ("GameOverControl").GetComponent<GameOverQuit> ().HideCanvas ();
		}
	}
